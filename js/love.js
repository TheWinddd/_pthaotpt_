...
function restartAnimation() {
    ...
    // Reset visibility/display and child states of the original block
    block.style.display = "block";
    block.style.visibility = "hidden";
    if (block.children && block.children[2]) {
        block.children[2].style.display = "";
    }

    // Reset container position
    love.style.top = initial_love_top + "px";
